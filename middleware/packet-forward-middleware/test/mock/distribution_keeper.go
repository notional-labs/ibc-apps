...
//
//	mockgen -package=mock -destination=./test/mock/distribution_keeper.go github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v7/packetforward/types DistributionKeeper
//
...
func (mr *MockDistributionKeeperMockRecorder) FundCommunityPool(arg0, arg1, arg2 any) *gomock.Call {
